...
SELECT * FROM city JOIN country ON city.countrycode = country.code WHERE country.code = 'SMR';
...
------+------------+-------------+-------------------+------------+------+------------+-----------+-----------------+-------------+-----------+------------+----------------+--------+--------+------------+----------------+-------------+---------+-------
 ...
 3171 | San Marino | SMR         | San Marino        |       2294 | SMR  | San Marino | Europe    | Southern Europe |          61 |       885 |      27000 |           81.1 | 510.00 |        | San Marino | Republic       |             |    3171 | SM
(2 rows)
